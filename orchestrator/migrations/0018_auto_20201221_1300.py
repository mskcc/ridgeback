...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('orchestrator', '0017_auto_20200624_1635'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='job',
            name='status',
            field=models.IntegerField(choices=[(0, 'CREATED'), (1, 'PENDING'), (2, 'RUNNING'), (3, 'COMPLETED'), (4, 'FAILED'), (5, 'ABORTED'), (6, 'UNKNOWN')], default=orchestrator.models.Status(0)),
        ),
