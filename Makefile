...
export SINGULARITYENV_RIDGEBACK_CELERY_LOG_PATH:=$(CELERY_LOG_PATH)
export SINGULARITYENV_RIDGEBACK_CELERY_PID_PATH:=$(CELERY_PID_PATH)
export SINGULARITYENV_RIDGEBACK_CELERY_BEAT_SCHEDULE_PATH:=$(CELERY_BEAT_SCHEDULE_PATH)
...
export RIDGEBACK_SERVICE_SIF:=../ridgeback.sif
singularity-start:
